/**
 * This is copied directly from the `ical-expander` NPM
 * package but with the `require()` calls removed and
 * handled ourselves because it was not originally written
 * to be friendly to the browser.
 */

const timezones = await fetch('/static/js/zones-compiled.json').then( (data) => {
    return data.json();
} );
