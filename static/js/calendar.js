...
export default new FullCalendar.Calendar(document.getElementById('calendar'), {
    ...
    eventSources: EventSources.concat([
        ...
        //
        // Sadly, TV Eye is refusing connections from us for now so we'll need another
        // way around this at some point. Possible CORS headers from the CLoudflare edge?
